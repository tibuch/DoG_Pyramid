...
public class DoG<T extends RealType<T>> implements Command {
    ...
    public void run() {
        ...
        for (int i = 0; i < levels; i++) {
            ...
            // This doesn't make sense in this case, because we have to set s1 and s2 in every iteration.
            final UnaryComputerOp dog_op = (UnaryComputerOp) ops.op("filter.dog", dog_img, converted, s1, s2);
            dog_op.compute(converted, dog_img);
